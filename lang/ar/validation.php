...
return [
    ...
    |
    */
    "The selected product does not belong to the specified category" => "المنتج المحدد لا ينتمي إلى الفئة المحددة",
    ...
    'lowercase' => 'الحقل :attribute يجب أن يتكون من حروف صغيرة.',
    'lt' => [
        ...
        'string' => 'يجب أن يكون طول نص حقل :attribute أقل من :value حروفٍ/حرفًا.',
    ],
    'lte' => [
        ...
        'string' => 'يجب أن لا يتجاوز طول نص حقل :attribute :value حروفٍ/حرفًا.',
    ],
    ...
    'max' => [
        ...
        'string' => 'يجب أن لا يتجاوز طول نص حقل :attribute :max حروفٍ/حرفًا.',
    ],
    ...
    'min_digits' => 'الحقل :attribute يجب أن يحتوي على الأقل :min رقم/أرقام.',
    'missing' => 'الحقل :attribute يجب أن يكون مفقوداً.',
    'missing_if' => 'الحقل :attribute يجب أن يكون مفقوداً عندما يكون :other يساوي :value.',
    'missing_unless' => 'الحقل :attribute يجب أن يكون مفقوداً ما لم يكن :other يساوي :value.',
    'missing_with' => 'الحقل :attribute يجب أن يكون مفقوداً عند توفر :values.',
    'missing_with_all' => 'الحقل :attribute يجب أن يكون مفقوداً عند توفر :values.',
    ...
    'uppercase' => 'الحقل :attribute يجب أن يتكون من حروف كبيرة.',
