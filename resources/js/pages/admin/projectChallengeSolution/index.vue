<template>
    <div>
              ...
              <div class="table-responsive mb-2">
                <table class="table text-nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th scope="col">{{ $t('label.projects') }}</th>
      ...
      <!-- End:: data table -->
      <ModalCreateAndUpdate v-model="modalShow" :dataProjects="dataProjects" :type="type" :dataRow="dataRow" @created="getData(pagePaginate)" />
...
export default {
  ...
  setup(){
    ...
    onMounted(() => {
        uri.value = 'project-challenge-solutions';
        getProjects();
        getData();
        step.value = 1;
    });
    ...
    return {getData,statuses,filterColumns,loading,search,deleteData,showEditMode,showModelCreate,data,dataPaginate,type,dataRow,modalShow,pagePaginate,dataProjects};
