              ...
              <div class="table-responsive mb-2">
                <table class="table text-nowrap table-striped">
                  ...
                  <tr v-for="(item,index) in data" :key="item.id">
                    ...
                    <td>
                      <img v-if="item.media" :src="item.media" alt="image" width="100" height="100" />
                    </td>
                    <td>{{item.title}}</td>
                    <td>{{item.category}}</td>
                    <td>{{item.slug}}</td>
                    <td>{{item.status == true ? $t('global.active'): $t('global.Inactive')}}</td>
                    <td>
