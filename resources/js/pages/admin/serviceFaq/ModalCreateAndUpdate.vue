        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                      <div class="col-md-12">
                          <label class="form-label">{{ $t('label.service') }}</label>
                          <Select v-model="submitData.data.service_id"
                          ...
                          <div class="invalid-feedback" style="display: block">
                            <template v-if="errors['service_id']">
                              <error-message
                                v-for="(errorMessage, index) in errors['service_id']"
                                :key="index"
                              >
                                {{ errorMessage }}
                              </error-message>
                       ...
                       <div class="col-md-12 mb-2">
                         ...
                         <div class="col-md-12 mb-2">
                          <label class="form-label">{{ $t('global.questionAr') }}</label>
                        ...
                        <div class="col-md-12 mb-2">
                          <label class="form-label">{{ $t('global.questionEn') }}</label>
                          ...
                          <div class="invalid-feedback">
                            ...
                            <span v-if="v$.title_en.minLength?.$invalid">
                              {{ $t('validation.QuestionEnIsMustHaveAtMost') }}
                              {{ v$.title_en.minLength.$params.min }}
                              {{ $t('validation.Letters') }}<br />
                            </span>

                            <span v-if="v$.title_en.maxLength?.$invalid">
                              {{ $t('validation.QuestionEnIsMustHaveAtLeast') }}
                       ...
                       <div class="col-md-12 mb-2">
                          <label class="form-label">{{ $t('global.answerAr') }}</label>

                          <textarea
                            type="text"
                            class="form-control form-control-lg"
                            v-model="v$.description_ar.$model"
                            :class="{
                              'is-invalid': v$.description_ar.$error || errors['description_ar'],
                              'is-valid': !v$.description_ar.$invalid && !errors['description_ar']
                            }"
                          > </textarea>
                          ...
                          <div class="invalid-feedback">
                           ...
                           <span v-if="v$.description_ar.minLength?.$invalid">
                            {{ $t('validation.AnswerArIsMustHaveAtMost') }}
                        ...
                        <div class="col-md-12 mb-2">
                          <label class="form-label">{{ $t('global.answerEn') }}</label>

                          <textarea
                            type="text"
                            class="form-control form-control-lg"
                            v-model="v$.description_en.$model"
                            :class="{
                              'is-invalid': v$.description_en.$error || errors['description_en'],
                              'is-valid': !v$.description_en.$invalid && !errors['description_en']
                            }"
                          ></textarea>  
                          ...
                          <div class="invalid-feedback">
                            ...
                            <span v-if="v$.description_en.minLength?.$invalid">
                              {{ $t('validation.AnswerEnIsMustHaveAtMost') }}
...
<script setup>
  ...
  function resetModal() {
    ...
    setTimeout(async () => {
      if (props.type != 'edit') {
        ...
        adminApi.get(`service-faqs/${id.value}`)
            .then((res) => {
              loading.value = true;
              let l = res.data.data;
              ...
              submitData.data.service_id = l.service_id;
  ...
  const AddSubmit = () =>  {
      ...
      formData.append('service_id', submitData.data.service_id);
      ...
      if (props.type !== 'edit') {
        if (!v$.value.$error) {
          is_disabled.value = false;
          loading.value = true;
          adminApi.post(`service-faqs`, formData)
              .then((res) => {
                Swal.fire({
                  icon: 'success',
        ...
        adminApi.post(`service-faqs/${id.value}`,formData)
            .then((res) => {
              Swal.fire({
                icon: 'success',
