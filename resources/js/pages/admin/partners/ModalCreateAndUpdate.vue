        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-2" v-for="lang in languages">
                      ...
                      <div class="col-md-12 mb-2">
                        <label class="form-label">لنك </label>
                        ...
                        <div class="col-md-12 mt-3">
                          <label class="form-label">صورة (30 * 175)</label>
  ...
  function resetModal() {
    ...
    setTimeout(async () => {
      if (props.type != 'edit') {
        ...
        adminApi.get(`partners/${id.value}`)
            .then((res) => {
              loading.value = true;
              let l = res.data.data;
    ...
    if(submitData.data.image) {
      ...
      if (props.type !== 'edit') {
        if (!v$.value.$error) {
          is_disabled.value = false;
          loading.value = true;
          adminApi.post(`partners`, formData)
              .then((res) => {
                Swal.fire({
                  icon: 'success',
        ...
        adminApi.post(`partners/${id.value}`,formData)
            .then((res) => {
              Swal.fire({
                icon: 'success',
