                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-2" v-for="lang in languages">
                        ...
                        <div class="col-md-6 mb-2">
                          ...
                          <input type="number" class="form-control form-control-lg"  v-model="v$.year.$model"
                                 :class="{'is-invalid': v$.year.$error || errors[`year`],
                                     'is-valid': !v$[`year`].$invalid && !errors[`year`]}">

                          <div class="invalid-feedback">
                            <span v-if="v$[`year`].required.$invalid">{{ $t('validation.fieldRequired') }}<br /> </span>
                          </div>
                          <template v-if="errors[`year`]">
                            <error-message v-for="(errorMessage, index) in errors[`year`]" :key="index">
                              {{ errorMessage }}
                            </error-message>
                          </template>
                        </div>
                        ...
                        <div class="col-md-6 mt-3">
                          <label class="form-label">صورة الخلفية (1920 * 950)</label>
                        ...
                        <div class="col-md-6 mt-3">
                        <label class="form-label">صورة (784 * 700)</label>
                        <div class="row img-div-position">
                          <div class="col-12 text-end">
                            <button
                                type="button" class="btn btn-danger btn-sm"
...
<script setup>
  ...
  function defaultData(){
    ...
    let b = document.querySelector('#container-images1');
    if(i) { i.innerHTML = ''; }
    if(b) { b.innerHTML = ''; }
  }
  function resetModal() {
  ...
  const rules = computed(() => {
    return {
      ...
      year: {integer,maxLength:maxLength(200),required,},
