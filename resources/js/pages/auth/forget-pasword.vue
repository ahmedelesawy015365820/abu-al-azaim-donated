<template>
  <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
    ...
    <!--          <p class="h5 fw-semibold mb-2 text-center">Reset Password</p>-->
              <p class="mb-4 text-muted op-7 fw-normal text-center">{{ $t('global.Forgot your password No problem') }}</p>
              <div class="row gy-3">
                <div class="col-xl-12">
              ...
              <div class="text-center">
                <p class="fs-12 text-muted mt-3">Already have an account? <a href="/login" class="text-primary">Sign In</a></p>
              </div>
