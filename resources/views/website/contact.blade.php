                ...
                <div class="row">
                    <div class="col col-lg-4 col-md-6 col-12">
                        <div class="office-info-item">
                            ...
                            <div class="office-info-text">
                                <h2>{{ __('website.Address') }}</h2>
                                <p>5 ش ابن سندر , برج السماح , مصر الجديدة</p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-lg-4 col-md-6 col-12">
                    ...
                    <div class="col col-lg-4 col-md-6 col-12">
                        <div class="office-info-item">
                            ...
                            <div class="office-info-text">
                                <h2>{{ __('website.Email Address') }}</h2>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="contact-left">
                            <h2>{{ __('website.Get In Touch') }}</h2>
                            <p>الموقع الموضّح على الخريطة هو مكتب الجمعية .</p>
                            <div class="map">
                                <iframe
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="contact-right">
                            <div class="title">
                                <h2>إملأ النموذج</h2>
                                <p>لن يُنشر عنوان بريدك الإلكتروني. الحقول المطلوبة مُشار إليها بـ *.</p>
                            </div>
                            <form id="contactForm" class="contact-form">
                                <div class="input-item">
                                    <input id="name" class="fild" type="text" placeholder="{{ __('website.Your Name') }} *" required>
                                    <label><i class="flaticon-user"></i></label>
                                </div>
                                <div class="input-item">
                                    <input id="email" class="fild" type="email" placeholder="{{ __('website.Email Address') }} *"
                                           required>
                                    <label><i class="flaticon-email"></i></label>
                                </div>
                                <div class="input-item">
                                        <textarea id="message" class="fild textarea"
                                                  placeholder="أدخل رسالتك هنا" required></textarea>
                                    <label><i class="flaticon-edit"></i></label>
                                </div>
                                <div class="input-item submitbtn">
                                    <input class="fild" type="submit" value="{{ __('website.Get In Touch') }}">
                                </div>
                            </form>
                        </div>
                    </div>
