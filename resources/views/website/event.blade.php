                ...
                <div class="row g-0">
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            ...
                            <div class="icon">
                                <a href="{{ route('event-details') }}"><i>+</i>
                                    <div class="shape">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.food_water_charity') }}</a></h2>
                    ...
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.become_volunteer') }}</a></h2>
                    ...
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.send_gift_for_children') }}</a></h2>
                    ...
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            <img src="{{ asset('website/images/mission-vission/4.jpg') }}" alt="">
                            <div class="icon">
                                <a href="{{ route('event-details') }}"><i>+</i>
                                    <div class="shape">
                                        <svg viewBox="0 0 98 99" fill="none">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.help_for_children') }}</a></h2>
                                <i class="flaticon-handshake"></i>
                            </div>
                        </div>
                    </div>
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            <img src="{{ asset('website/images/mission-vission/5.jpg') }}" alt="">
                            <div class="icon">
                                <a href="{{ route('event-details') }}"><i>+</i>
                                    <div class="shape">
                                        <svg viewBox="0 0 98 99" fill="none">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.event_raised_poor') }}</a></h2>
                                <i class="flaticon-handshake"></i>
                            </div>
                        </div>
                    </div>
                    <div class=" col-lg-4 col-md-6 col-12">
                        <div class="card-mv">
                            <img src="{{ asset('website/images/mission-vission/6.jpg') }}" alt="">
                            <div class="icon">
                                <a href="{{ route('event-details') }}"><i>+</i>
                                    <div class="shape">
                                        <svg viewBox="0 0 98 99" fill="none">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('event-details') }}">{{ __('website.a_hand_for_children') }}</a></h2>
                                <i class="flaticon-handshake"></i>
                            </div>
                        </div>
                    </div>
