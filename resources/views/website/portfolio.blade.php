            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcumb-wrap">
                        ...
                        <h3><span>التبرعات</span> السابقة</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="project-wrap">
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/1.jpg') }}" alt="مأوى للمشردين">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">مأوى للمشردين</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
                        </div>
                        <div class="icon"><a href="/portfolio/portfolio-details/test"><i class="flaticon-right-arrow"></i></a></div>
                    </div>
                </div>
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/2.jpg') }}" alt="تمكين من خلال الغذاء">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">تمكين من خلال الغذاء</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
                        </div>
                        <div class="icon"><a href="/portfolio/portfolio-details/test"><i class="flaticon-right-arrow"></i></a></div>
                    </div>
                ...
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/3.jpg') }}" alt="رعاية المسنين والأطفال">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">رعاية المسنين والأطفال</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
                        </div>
                        <div class="icon"><a href="/portfolio/portfolio-details/test"><i class="flaticon-right-arrow"></i></a></div>
                    </div>
                ...
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/4.jpg') }}" alt="مياه نظيفة للمناطق الريفية">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">مياه نظيفة للمناطق الريفية</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
                        </div>
                        <div class="icon"><a href="/portfolio/portfolio-details/test"><i class="flaticon-right-arrow"></i></a></div>
                    </div>
                ...
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/5.jpg') }}" alt="تمكين من خلال الغذاء">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">تمكين من خلال الغذاء</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
                ...
                <div class="project-grid">
                    <img src="{{ asset('website/images/project/albam/6.jpg') }}" alt="مأوى للمشردين">
                    <div class="content">
                        <div>
                            <h2><a href="/portfolio/portfolio-details/test">مأوى للمشردين</a></h2>
                            <span>رعاية الأطفال والمسنين</span>
